...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeadCMS.Plugin.EmailSync.Entities.ImapAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LeadCMS.Plugin.EmailSync.Entities.ImapAccountFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LeadCMS.Plugin.EmailSync.Entities.ImapAccount", b =>
                {
                    b.HasOne("LeadCMS.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("LeadCMS.Plugin.EmailSync.Entities.ImapAccountFolder", b =>
                {
                    b.HasOne("LeadCMS.Plugin.EmailSync.Entities.ImapAccount", "ImapAccount")
                        .WithMany()
