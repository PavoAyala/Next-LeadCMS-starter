...
namespace LeadCMS.Migrations
{
    ...
    [Migration("20260117142415_AddAccountOrderCountAndTotalRevenue")]
    partial class AddAccountOrderCountAndTotalRevenue
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeadCMS.Entities.Contact", b =>
                {
                    ...
                    b.Property<string>("FullName")
                        ...
                        .HasComputedColumnSql("TRIM(COALESCE(\"first_name\", '') || ' ' || COALESCE(\"middle_name\", '') || ' ' || COALESCE(\"last_name\", ''))", true);
